...
res.render('index', { title: 'Parking App', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'Parking App Registration'});
});
...
res.render('login', { title: 'Parking App Login', user : req.user });
});
